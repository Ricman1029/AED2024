...
from funciones import pais_destino, determinar_importe_final, seleccion, mostrar_cantidad_tipo, mostrar_acumulado_envio, cantidad_datos, opcion_borrar, leer_archivo, ingresar_tipo, ingresar_pago, imprimir_datos, buscar_direccion_tipo, determinar_control, validacion_envios
