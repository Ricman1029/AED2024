...
def llenar_tablero(tablero, contexto):
    ...
    if menor_diponibilidad is None:
        return True

    contexto.movimiento += 1
    contexto.posicion_actual = saltar(tablero, posicion_actual, menor_diponibilidad, contexto.movimiento)
